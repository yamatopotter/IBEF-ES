...
function register_image_sizes(){
    ...
    add_image_size( 'small-stripe', 285, 37, true );
    add_image_size( 'medium-stripe', 570, 75, true );
    add_image_size( 'large-stripe', 1140, 150, true );

    add_image_size( 'banner-destaque', 1140, 415, array( 'center' , 'top' ) );
    add_image_size( 'banner-cartao', 263, 95, array( 'center' , 'top' ) );
    add_image_size( 'banner-fita', 1140, 95, array( 'center' , 'top' ) );
}